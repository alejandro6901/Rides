            ...
            <div class="popup-container">
                ...
                <form class="popup-cont" action="<?php echo base_url()."index.php/User/authenticate"?>" method="post">
                    ...
                    <div class="item-popup">
                        ...
                        <div id="LoginErrorContainer"><?php  echo $data['error'] ?></div>
                    </div>
                    <input type="submit" name="name" value="Login">
                    <div class="item-popup last">

                        <!-- <input type="submit" class="btn-style-in"  value="Login"> -->
    ...
    <section id="window-signin" class="close-popup">
        <div class="cover-popup">
            <div class="popup-container">
                ...
                <form class="popup-cont" action="<?php echo base_url(); ?>index.php/User/insertUser" method="post">
                    <div class="item-popup">
                        <label class="label-style" for="">User</label>
                    ...
                    <div class="item-popup last">
                        <input type="submit" class="btn-style-in"  name="register" value="Register">
